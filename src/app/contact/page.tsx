                        ...
                        <div className="space-y-4 md:space-y-6 max-w-md mx-auto lg:mx-0">
                            <div className="bg-white/5 border border-white/10 p-4 md:p-6 rounded-2xl flex items-start gap-4">
                                ...
                                <div className="text-left">
                                    ...
                                    <a href="mailto:info@linguaenlinea.eu" className="text-slate-400 hover:text-primary transition-colors text-sm md:text-base break-words">
                                        info@linguaenlinea.eu
                                    </a>
                                </div>
                            </div>
