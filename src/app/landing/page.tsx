    ...
    return (
        <div className="bg-background-dark text-slate-100 antialiased font-display">
            ...
            <section className="relative min-h-[90vh] flex flex-col items-center justify-center overflow-hidden px-6 text-center bg-mesh">
                ...
                <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center gap-8">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mt-4">
                        <button
                            onClick={handleStart}
                            className="group relative px-8 py-4 bg-primary text-white rounded-xl font-bold text-lg shadow-[0_0_40px_rgba(255,107,107,0.4)] transition-all hover:scale-105 active:scale-95"
                        >
                            Start nu gratis ▶
                        </button>
                        <button
                            onClick={scrollToHowItWorks}
                            className="px-8 py-4 bg-white/5 border border-white/10 text-white rounded-xl font-bold text-lg hover:bg-white/10 transition-all font-display"
                        >
            ...
            <section className="max-w-6xl mx-auto px-6 -mt-16 relative z-20">
                <div className="bg-card-dark border border-white/10 rounded-2xl p-8 grid grid-cols-2 md:grid-cols-4 gap-8 shadow-2xl">
                    <div className="flex flex-col items-center md:items-start gap-1">
                        <Library className="w-6 h-6 text-primary mb-1" />
                        <span className="text-white font-bold text-xl">24 lessen</span>
                        <span className="text-slate-500 text-xs uppercase font-bold tracking-wider">Content</span>
                    </div>
                    <div className="flex flex-col items-center md:items-start gap-1">
                        <Zap className="w-6 h-6 text-gold mb-1" />
                        <span className="text-white font-bold text-xl">XP systeem</span>
                        <span className="text-slate-500 text-xs uppercase font-bold tracking-wider">Gamification</span>
                    </div>
                    <div className="flex flex-col items-center md:items-start gap-1">
                        <Trophy className="w-6 h-6 text-primary mb-1" />
                        <span className="text-white font-bold text-xl">Achievements</span>
                        <span className="text-slate-500 text-xs uppercase font-bold tracking-wider">Progressie</span>
                    </div>
                    <div className="flex flex-col items-center md:items-start gap-1">
                        <Users className="w-6 h-6 text-gold mb-1" />
                        <span className="text-white font-bold text-xl">Community</span>
                        <span className="text-slate-500 text-xs uppercase font-bold tracking-wider">Interactie</span>
                    </div>
                </div>
            </section>
            ...
            <section className="py-12 px-6 max-w-6xl mx-auto">
                <div className="text-center mb-8">
                    <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-4">Het beste van twee werelden</h2>
            ...
            {/* HOW IT WORKS */}
            <section id="how-it-works" className="py-12 px-6 bg-white/5">
            ...
            <section className="py-12 px-6">
                <div className="max-w-4xl mx-auto">
                    <div className="bg-card-dark border-l-8 border-[#1877F2] p-8 md:p-12 rounded-2xl flex flex-col md:flex-row items-center justify-between gap-8 shadow-2xl">
                        <div className="flex items-center gap-6">
                            <div className="w-16 h-16 bg-[#1877F2] rounded-full flex items-center justify-center text-white text-3xl shadow-lg shadow-[#1877F2]/30">
                                <Facebook className="w-8 h-8" />
                            </div>
                            <div>
                                <h3 className="text-2xl font-extrabold text-white mb-2 font-display">Word lid van de Linguaenlinea Community</h3>
                                <p className="text-slate-400 font-display">Oefen samen met andere leerlingen op Facebook.</p>
                            </div>
                        </div>
                        <a href="https://www.facebook.com/linguaenlinea" target="_blank" className="whitespace-nowrap bg-[#1877F2] hover:bg-[#1877F2]/90 text-white px-8 py-3 rounded-xl font-bold transition-all shadow-lg active:scale-95">
            ...
            {/* FINAL CTA */}
            <section className="py-12 px-6">
                <div className="max-w-5xl mx-auto bg-gradient-to-br from-primary to-orange-500 rounded-[3rem] p-12 md:p-24 text-center text-white relative overflow-hidden shadow-2xl shadow-primary/20">
                    <div className="relative z-10 flex flex-col items-center gap-8">
                        <h2 className="text-4xl md:text-6xl font-black tracking-tight font-display">Klaar om te beginnen?</h2>
