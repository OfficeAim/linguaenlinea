        ...
        <div className="bg-background-dark text-slate-100 antialiased font-display">
            ...
            <section className="relative min-h-[90vh] flex flex-col items-center justify-center overflow-hidden px-4 md:px-8 lg:px-16 text-center bg-mesh">
                ...
                <div className="absolute inset-0 pointer-events-none select-none overflow-hidden opacity-10">
                    <span className="absolute top-1/4 left-10 text-[#e63946] text-4xl font-bold rotate-12">¡Hola!</span>
                    <span className="absolute top-1/3 right-20 text-[#e63946] text-3xl font-bold -rotate-6">Me llamo...</span>
                    <span className="absolute bottom-1/4 left-20 text-[#e63946] text-2xl font-bold -rotate-12">Buenos días</span>
                    <span className="absolute bottom-1/3 right-10 text-[#e63946] text-4xl font-bold rotate-6">¿Cómo te llamas?</span>
                </div>
                <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center gap-8">
                    <div className="inline-flex items-center px-4 py-1.5 rounded-full border border-primary/50 bg-primary/10 text-[#e63946] text-xs font-bold tracking-wide uppercase">
                    ...
                    <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold leading-[1.1] tracking-tight text-white font-display">
                        Leer Spaans. <span className="text-[#e63946]">Gratis.</span><br className="hidden sm:block" /> In 10 minuten per dag.
                    </h1>
            ...
            <section className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 -mt-8 md:-mt-16 relative z-20">
                <div className="bg-card-dark border border-white/10 rounded-2xl p-6 md:p-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 shadow-2xl">
                    <div className="flex flex-row md:flex-col items-center md:items-start gap-4 md:gap-1">
                        <Library className="w-6 h-6 text-[#e63946] mb-1" />
                        <div>
                    ...
                    <div className="flex flex-row md:flex-col items-center md:items-start gap-4 md:gap-1">
                        <Trophy className="w-6 h-6 text-[#e63946] mb-1" />
                        <div>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                        <div className="bg-card-dark p-6 md:p-8 rounded-3xl border border-white/5 hover:border-primary/30 transition-all flex flex-col items-center text-center">
                            <BookOpen size={64} className="text-[#e63946] mx-auto mb-6" />
                            <div className="text-[#e63946] font-black text-2xl mb-2 font-display">Zelfstudie</div>
                        ...
                        <div className="bg-card-dark p-6 md:p-8 rounded-3xl border border-white/5 hover:border-primary/30 transition-all flex flex-col items-center text-center">
                            <Headphones size={64} className="text-[#e63946] mx-auto mb-6" />
                            <div className="text-[#e63946] font-black text-2xl mb-2 font-display">Oefening</div>
                        ...
                        <div className="bg-card-dark p-6 md:p-8 rounded-3xl border border-white/5 hover:border-primary/30 transition-all flex flex-col items-center text-center">
                            <Users size={64} className="text-[#e63946] mx-auto mb-6" />
                            <div className="text-[#e63946] font-black text-2xl mb-2 font-display">Community</div>
                    ...
                    titleComponent={
                        <div className="flex flex-col items-center mb-8">
                            <h2 className="text-3xl md:text-6xl font-extrabold text-white mb-2">
                                Wat je leert in <span className="text-[#e63946]">Les 1.1</span>
                            </h2>
                ...
                >
                    <div className="bg-card-dark h-full">
                        <div className="flex border-b border-white/10 bg-white/5">
                            <button className="px-6 py-4 text-[#e63946] font-bold border-b-2 border-primary">Understand</button>
                        ...
                        <div className="p-8 space-y-8 overflow-y-auto custom-scrollbar h-[calc(100%-60px)]">
                            <div className="p-4 border-l-4 border-primary bg-primary/5 rounded-r-xl">
                                <h5 className="text-[#e63946] font-bold uppercase text-xs tracking-widest mb-1 flex items-center gap-2">
                    ...
                    <div className="flex flex-wrap justify-center gap-8">
                        ...
                        <div className="w-64 bg-card-dark p-6 rounded-2xl border border-white/10 -rotate-2 transform hover:rotate-0 transition-all hover:scale-110 shadow-xl">
                            <div className="w-20 h-20 bg-primary/20 rounded-full flex items-center justify-center mx-auto mb-4">
                                <span className="text-[#e63946] text-4xl">🏆</span>
                            </div>
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-12 md:index-16">
                        <h2 className="text-3xl md:text-4xl font-black text-white mb-4">
                            Groeiende <span className="text-[#e63946]">gemeenschap</span>
                        </h2>
            ...
            <section className="py-10 px-6">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        <span className="px-6 py-2 bg-primary/10 border border-primary/30 rounded-full text-[#e63946] font-bold text-sm">SLO 38C</span>
                        <span className="px-6 py-2 bg-primary/10 border border-primary/30 rounded-full text-[#e63946] font-bold text-sm">SLO 39A</span>
                        <span className="px-6 py-2 bg-primary/10 border border-primary/30 rounded-full text-[#e63946] font-bold text-sm">SLO 39B</span>
                    </div>
                </div>
            </section>
            ...
            <footer className="py-12 md:py-16 px-4 md:px-8 lg:px-16 border-t border-white/5 bg-background-dark">
                <div className="max-w-6xl mx-auto flex flex-col items-center gap-8 md:gap-12">
                    ...
                    <div className="flex flex-wrap justify-center gap-x-8 gap-y-4 text-slate-400 font-bold text-sm font-display">
                        <Link className="hover:text-[#e63946] transition-colors" href="/over-ons">Over ons</Link>
                        <Link className="hover:text-[#e63946] transition-colors" href="/contact">Contact</Link>
                        <Link className="hover:text-[#e63946] transition-colors" href="/privacy">Privacy</Link>
                        <Link className="hover:text-[#e63946] transition-colors" href="/faq">FAQ</Link>
                        <a className="hover:text-[#e63946] transition-colors" href="https://www.facebook.com/linguaenlinea" target="_blank">Facebook</a>
                    </div>
