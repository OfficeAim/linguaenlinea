                        ...
                        <div className="pl-2 md:pl-4">
                            <div className="flex items-center gap-3 mb-6 md:mb-8">
                                ...
                                <div>
                                    ...
                                    <p className="text-white/50 text-[10px] md:text-xs">Oprichter van Linguaenlinea · Het idee is geboren op het Da Vinci College · Now for the world</p>
                                </div>
                            </div>
                            <div className="space-y-4 md:space-y-5 text-slate-300 leading-relaxed text-sm md:text-base">
                                <p>Alle lessen worden gemaakt door Rody Figueroa, een ervaren taal docent. We gebruiken NotebookLM (Google) als vertaler van kennisbank voor de lesinhoud, zodat alles pedagogisch verantwoord is.</p>
                                ...
                                <p className="text-white font-medium">Ik heb mijn beroep als leraar achter me gelaten om me volledig te wijden aan de ontwikkeling van este platform — omdat ik geloof dat elke leerling, waar ook ter wereld, toegang verdient tot kwalitatief hoogwaardig Spaans onderwijs.</p>
                            </div>
                        </div>
                    </motion.div>
                </section>
