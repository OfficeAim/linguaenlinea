    ...
    return (
        <div className="min-h-screen bg-brand-charcoal flex flex-col items-center justify-center p-4">
            <motion.div 
                ...
                className="w-full max-w-2xl bg-brand-charcoal-light rounded-2xl shadow-2xl p-8 border border-gray-800 text-center"
            >
                ...
                <p className="text-slate-300 text-lg mb-8 leading-relaxed">
                    ...
                    <br/><br/>
                    Geen zorgen, we beginnen bij de basis van de uitspraak zodat je direct als een native klinkt.
                </p>
