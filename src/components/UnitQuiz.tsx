    ...
    return (
        <div className="fixed inset-0 z-50 bg-[#121212] overflow-y-auto">
            ...
            <div className="sticky top-0 p-4 flex justify-end z-10">
                <button onClick={() => onClose(screen === 'results')} className="bg-brand-charcoal-light hover:bg-[#3a3a4e] text-white p-3 rounded-full transition-colors">
                    <X className="w-6 h-6" />
                </button>
            </div>
                    ...
                    <div className="w-full max-w-xl mx-auto text-center animate-in zoom-in-95 duration-500">
                        ...
                        {passed ? (
                            <div className="flex flex-col gap-4">
                                ...
                                <button
                                    onClick={() => router.push('/lesson/1b86170e-761a-4c28-baea-b5a30aa4f17b')}
                                    className="w-full bg-[#4CAF50] hover:bg-[#43a047] text-white font-bold px-8 py-4 rounded-xl text-lg mb-3 shadow-[0_0_20px_rgba(76,175,80,0.3)] flex items-center justify-center gap-2"
                                >
                                    Naar Les 1.2 →
                                </button>
                                <button
